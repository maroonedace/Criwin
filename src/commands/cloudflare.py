...
class Config:
    ...
    CLOUDFLARE_SOUND_TABLE_NAME = os.getenv("CLOUDFLARE_SOUND_TABLE_NAME")
    CLOUDFLARE_IMAGE_TABLE_NAME = os.getenv("CLOUDFLARE_IMAGE_TABLE_NAME")
...
class DatabaseOperations:
    ...
    def get_all_sounds() -> List[Dict[str, Any]]:
        ...
        try:
            query = f"SELECT * FROM {Config.CLOUDFLARE_SOUND_TABLE_NAME};"
    ...
    def add_sound(name: str, file_name: str) -> None:
        ...
        try:
            query = f"""
                INSERT INTO "{Config.CLOUDFLARE_SOUND_TABLE_NAME}" (name, file_name) 
    ...
    def delete_sound(name: str) -> None:
        ...
        try:
            query = f"""
                DELETE FROM "{Config.CLOUDFLARE_SOUND_TABLE_NAME}" 
                WHERE name = :name;
            """
